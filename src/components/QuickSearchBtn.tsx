  ...
  return (
    <button
      ...
      className={clsx(
        ...
        'ring-1 ring-slate-300 transition hover:text-slate-200 hover:ring-slate-400',
        'space-x-3 text-slate-400 focus:outline-none md:py-1.5 hover:bg-teal-300 hover:bg-opacity-10'
      )}
